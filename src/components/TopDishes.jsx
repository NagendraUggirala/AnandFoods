      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-8">
          <div>
            ...
            <p className="text-gray-500 text-sm md:text-base mt-1">
              Handpicked favourites across salads, rolls, desserts, noodles & more.
            </p>
          </div>
          ...
          {filteredDishes.map((dish) => (
            ...
            >
              ...
              <div className="flex-1 px-5 pb-5 pt-4 flex flex-col">
                ...
                <div className="mt-auto text-orange-500 font-semibold text-lg">
                  ₹{dish.price}
                </div>
              </div>
            </article>
        ...
        <div className="mt-6 text-sm text-gray-600">
          {added.length > 0 ? (
            ...
            <span>Select dishes with the “+” button to add them.</span>
          )}
        </div>
      </div>
    </section>
